...
const CATEGORIES: CatalogCategory[] = [
  {
    name: 'Miniatures',
    productCount: 1,
    descriptionHtml: '<p>Flagship fleets, counters, and support pieces for tabletop warfare.</p>',
    subCategories: [{ name: 'Space Fleets', productCount: 1, descriptionHtml: '<p>Task-force bundles for campaign and pick-up play.</p>', subCategory2s: [{ name: 'Carriers', productCount: 1, descriptionHtml: '<p>Heavy support hulls and carrier-led formations.</p>' }] }],
  },
  {
    name: 'Rulebooks',
    productCount: 1,
    descriptionHtml: '<p>Core rules, supplements, and digital reading material.</p>',
    subCategories: [{ name: 'Digital Editions', productCount: 1, descriptionHtml: '<p>Downloadable reference books and searchable PDFs.</p>', subCategory2s: [{ name: 'Campaign Books', productCount: 1, descriptionHtml: '<p>Scenario-rich books built for longer arcs.</p>' }] }],
  },
  {
    name: 'Board Games',
    productCount: 1,
    descriptionHtml: '<p>Complete boxed experiences for the Columbia catalog.</p>',
    subCategories: [{ name: 'Starter Sets', productCount: 1, descriptionHtml: '<p>Entry-friendly boxes tuned for first sessions.</p>', subCategory2s: [{ name: 'Intro Boxes', productCount: 1, descriptionHtml: '<p>Low-friction starter bundles for new players.</p>' }] }],
  },
];
